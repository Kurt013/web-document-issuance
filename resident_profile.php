                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>City:</label>
                                    <input class="form-control" type="text" name="city" value="<?= $resident['city'];?>">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label>Municipality:</label>
                                    <input class="form-control" type="text" name="municipal" value="<?= $resident['municipal'];?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 5px;"> 
                            <div class="col-xl-12">
                                <div class="form-inline">
                                    ...
                                    <a href="resident_profile.php?id_resident=<?= $userdetails['id'];?>"></a>   
                                    <div>
                                        <br><br>
