    ...
    <body> 
        ...
        <section class="heading-section"> 
            ...
            <div class="container"> 
                ...
                <div class="row">
                    <div class="col"> 
                        <a href="services_business.php ?id_resident=<?= $userdetails['id'];?>">
                            <div class="zoom1"> 
                                <div class="card"> 
                    ...
                    <div class="col"> 
                        <a href="services_brgyid.php?id_resident=<?= $userdetails['id'];?>">
                            <div class="zoom1">
                                <div class="card"> 
                                    <div class="card-body text-center"> 
                    ...
                    <div class="col"> 
                        <a href="services_certofindigency.php ?id_resident=<?= $userdetails['id'];?>">
                            <div class="zoom1">
                                <div class="card"> 
                                    <div class="card-body text-center"> 
                ...
                <div class="row card-spacing"> 
                    <div class="col">
                        <a href="services_certofres.php ?id_resident=<?= $userdetails['id'];?>"> 
                        <div class="zoom1">    
                            <div class="card"> 
                                <div class="card-body text-center"> 
                    ...
                    <div class="col">
                        <a href="services_brgyclearance.php ?id_resident=<?= $userdetails['id'];?>"> 
                        <div class="zoom1">    
                            <div class="card"> 
                                <div class="card-body text-center">
