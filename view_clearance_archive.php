...
?>
    ...
    <a>
    <button class="btn btn-danger archive-btn" type="button" style="width: 70px; font-size: 17px;" title="Retrieve" name="unarchive_clearance">  <i class="fas fa-sync"></i> </button>
